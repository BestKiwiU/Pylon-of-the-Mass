const UPGRADES = {
    ...
    "E5": {
        ...
        get desc() { return `每级增加星尘生成<b>${formatMult(this.base)}</b>。` },
        curr: "star",
    ...
    "E6": {
        ...
        get desc() { return `每完成一个挑战，星尘生成增加<b>${formatMult(this.base)}</b>。` },
        curr: "star",
    ...
    "E7": {
        ...
        desc: `星尘以降低的速率提升<b>C12</b>和<b>E5</b>的基础值。`,
        curr: "star",
