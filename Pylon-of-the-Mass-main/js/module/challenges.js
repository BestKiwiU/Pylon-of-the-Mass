const CHALLENGES = [
    null,
    {
        ...
        max: 10, // 最大完成次数
        name: `能量减少`, // 挑战名称
        desc(c) { return `能量速率减少到 <b>${formatPow(this.base[c],3)}</b>.` }, // 挑战描述
        ...
        max: 5, // 最大完成次数
        name: `能量减少 II`, // 挑战名称
        desc(c) { return `能量和精炼能量减少到 <b>${formatPow(this.base[c],3)}</b>.` }, // 挑战描述
        ...
        max: 5, // 最大完成次数
        name: `指数能量减少`, // 挑战名称
        desc(c) { return `能量速率的指数减少到 <b>${formatPow(this.base[c],3)}</b>.` }, // 挑战描述
